...
(function () {
  ...
  // globs to match any jsx or js file in directory
  glob(`**/*.{js,jsx}`, { cwd: directory, nosort: true, ignore: ['node_modules/**', 'react/**'] }, (err, files) => { // TODO: CHANGE BACK
    ...
    // render react-monocle.html output with completed React component tree
    renderHtml(
      formatedD3Object, 
      modifiedBundle, 
      start,
      divsArr, 
      htmlElements ? htmlElements.scripts : [], 
      htmlElements ? htmlElements.css : []
    );
  });
})();
